...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.html">海华金融后台管理系统</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              ...
              <dd><a href="/admin/auth/logout.html">退出</a></dd>
            </dl>
          </li>
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/admin/member/memberlist.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>会员列表</cite>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/admin/order/orderlist.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>订单列表</cite>
                        </a>
                    </li >
            ...
            <?php if(isset($_SESSION['userinfo']['isadmin'])&&$_SESSION['userinfo']['isadmin']==1): ?>
            <li>
                <a href="javascript:;">
                    <i class="iconfont">&#xe726;</i>
                    <cite>管理员管理</cite>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/admin/admin/adminlist.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/admin/echarts/echarts1.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>拆线图</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/admin/echarts/echarts2.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>柱状图</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="/admin/echarts/echarts3.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>地图</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="/admin/echarts/echarts4.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>饼图</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="/admin/echarts/echarts5.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>雷达图</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="/admin/echarts/echarts6.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>k线图</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="/admin/echarts/echarts7.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>热力图</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="/admin/echarts/echarts8.html">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>仪表图</cite>
                        </a>
                    </li>
